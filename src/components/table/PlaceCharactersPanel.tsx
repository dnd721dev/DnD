                ...
                {isPlaced ? (
                  <div className="flex flex-col items-end gap-1">
                    ...
                    <button
                      ...
                      className="min-h-[36px] rounded border border-slate-700 px-2 py-1.5 text-[10px] text-slate-500 hover:text-red-400"
                    >
                      Remove
                    </button>
                  </div>
                  ...
                  <button
                    ...
                    className="min-h-[44px] min-w-[60px] rounded-md border border-sky-700/50 bg-sky-700/20 px-2.5 py-2 text-[11px] font-semibold text-sky-300 hover:bg-sky-700/40 disabled:opacity-40"
                  >
                    📍 Place
                  </button>
                )}
